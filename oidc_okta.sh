...
vault write auth/oidc/config oidc_discovery_url="https://dev-941076.oktapreview.com/oauth2/default" oidc_client_id="0oaibg2dkd1NzjOZW0h7" oidc_client_secret="F4YTt5fOmiA_E6VzbvsFQpe2OC6zA2BzRWIlocj8" default_role="test"
